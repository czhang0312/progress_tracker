...
# docker build -t progress_tracker .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name progress_tracker progress_tracker
...
# Install base packages (including libpq5 for pg gem at runtime)
